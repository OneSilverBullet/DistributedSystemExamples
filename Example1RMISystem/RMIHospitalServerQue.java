...
public class RMIHospitalServerQue {
    public static void main(String args[]){
        ...
        try {
            ...
            registry.rebind("rmi://localhost:1100/" + adminObjectName, adminStub);
            registry.rebind("rmi://localhost:1100/" + patientObjectName, patientStub);
            registry.rebind("rmi://localhost:1100/" + commonObjectName, commonStub);
