...
public class RMIHospitalServerShe {
    public static void main(String args[]){
        ...
        try {
            ...
            registry.rebind("rmi://localhost:1101/" + adminObjectName, adminStub);
            registry.rebind("rmi://localhost:1101/" + patientObjectName, patientStub);
            registry.rebind("rmi://localhost:1101/" + commonObjectName, commonStub);
